         ...
         lista.setOnItemClickListener(new AdapterView.OnItemClickListener() {
             ...
             public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                 switch (position){
                     ...
                     case 0:
                         video.setVideoURI(Uri.parse("android.resource://"+ getPackageName() + "/" + R.raw.resident));
                         break;
                     case 1:
                         video.setVideoURI(Uri.parse("android.resource://"+ getPackageName() + "/" + R.raw.dbs));
                         break;
                     case 2:
                         video.setVideoURI(Uri.parse("android.resource://"+ getPackageName() + "/" + R.raw.virus));
                         break;
                     default:
                         break;
                 }
